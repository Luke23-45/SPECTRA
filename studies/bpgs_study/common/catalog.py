...
def _collect_entries() -> list[StudyEntry]:
    from studies.bpgs_study.ablation.runner import AblationRunner
    from studies.bpgs_study.optional.runner import OptionalRunner
    from studies.bpgs_study.real_data.runner import RealDataRunner
    from studies.bpgs_study.stress.runner import StressRunner
